...
- `dashboard/` — FastAPI‑бэкенд (моки в памяти) для управления досками, стикерами и ролями участников.
- `AuthServer/` — минимальный ASP.NET Core API с JWT‑аутентификацией и SQL Server для хранения пользователей.
